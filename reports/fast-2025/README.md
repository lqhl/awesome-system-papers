...
#### [IMPRESS: An Importance-Informed Multi-Tier Prefix KV Storage System for LLM Inference](./fast2025-chen-weijian-impress.md)
...
#### [MOONCAKE: Trading More Storage for Less Computation — KVCache-centric LLM Serving](./fast2025-qin.md)
...
#### [LeapGNN: Accelerating Distributed GNN Training Leveraging Feature-Centric Model Migration](./fast2025-chen-weijian-leap.md)
- **作者**：Weijian Chen et al.
...
#### [FusionANNS: Towards High-throughput and Low-latency Billion-scale Vector Search via CPU/GPU Collaborative Filtering](./fast2025-tian-bing.md)
- **作者**：Bing Tian et al.
...
#### [GeminiFS: A Companion File System for GPUs](./fast2025-qiu.md)
- **作者**：Shi Qiu et al.
...
#### [GPHash: An Efficient Hash Index for GPU with Byte-Granularity Persistent Memory](./fast2025-chen-menglei.md)
...
#### [PIMLex: A High-Performance Learned Index with Processing-in-Memory](./fast2025-cui.md)
- **作者**：Lixiao Cui et al.
...
#### [HaSiS: A Hardware-assisted Single-index Store for Hybrid OLTP/OLAP](./fast2025-huang.md)
...
#### [SODE: Selective On-Device Execution of Data-Dependent Read I/Os](./fast2025-park.md)
...
#### [HiDPU: DPU-Oriented Hybrid Indexing for Disaggregated Storage](./fast2025-zhu.md)
- **作者**：Wenbin Zhu et al.
...
#### [PolyStore: Exploiting Combined Capabilities of Heterogeneous Storage](./fast2025-ren.md)
- **作者**：Yujie Ren et al.
...
#### [OrchFS: Rethinking Request-to-IO Transformation for Full Utilization of High-Bandwidth SSDs](./fast2025-zhan.md)
...
#### [ScaleLFS: A Log-Structured File System with Scalable Garbage Collection for Commodity SSDs](./fast2025-ha.md)
...
#### [D2FS: Device-Driven Filesystem Garbage Collection](./fast2025-kim-juwon.md)
...
#### [DJFS: Directory-Granularity Filesystem Journaling for CMM-H SSDs](./fast2025-yoo.md)
...
#### [GogetaFS: Merged Metadata Management in Deduplication FS](./fast2025-pan.md)
- **作者**：Yanqi Pan et al.
...
#### [Ananke: Fast, Transparent Filesystem Microkernel Recovery](./fast2025-liu-jing.md)
...
#### [NVLog: Boosting File Systems Elegantly via Transparent NVM Write-ahead Log for Disk File Systems](./fast2025-wang.md)
- **作者**：Guoyu Wang et al.
...
#### [MedFS: Pursuing Low Update Overhead via Metadata-Enabled Delta Compression for LFS on Mobile](./fast2025-wu.md)
- **作者**：Chao Wu et al.
...
#### [On Scalable Integrity Checking for Secure Cloud Disks](./fast2025-burke.md)
...
#### [AtomicDisk: A Secure Virtual Disk for TEEs against Eviction Attacks](./fast2025-tian-hongliang.md)
...
#### [AWUPF Rediscovered: Atomic Writes to Unleash Pivotal Fault-Tolerance in SSDs](./fast2025-jeon.md)
...
#### [Silhouette: Leveraging Consistency Mechanisms to Detect Bugs in PM File Systems](./fast2025-jiao.md)
- **作者**：Bing Jiao et al.
...
#### [OPIMQ: Order Preserving IO Stack for Multi-Queue Block Device](./fast2025-kim-jieun.md)
...
#### [AegonKV: A High Bandwidth, Low Tail Latency, and Low Storage Cost KV-Separated LSM Store with SmartSSD-based GC Offloading](./fast2025-duan.md)
...
#### [Revisiting Network Coding for Warm Blob Storage](./fast2025-gan.md)
- **作者**：Chuang Gan et al.
...
#### [3L-Cache: Low Overhead and Precise Learning-based Eviction Policy for Caches](./fast2025-zhou-wenbin.md)
...
#### [VectorCDC: Accelerating Data Deduplication with Vector Instructions](./fast2025-udayashankar.md)
...
#### [Archer: Adaptive Memory Compression with Page-Association-Rule Awareness](./fast2025-li.md)
...
#### [FlacIO: Flat and Collective I/O for Container Image Service](./fast2025-liu-yubo.md)
...
#### [Cloudscape: A Study of Storage Services in Modern Cloud Architectures](./fast2025-satija.md)
...
#### [LiqSD: Liquid-State Drive — DNA Block Device for Enormous Data](./fast2025-zhou-jiahao.md)
...
#### [DNA Data Storage: A Generative Tool for Motif-based DNA Storage](./fast2025-brunmayr.md)
...
#### [ShiftLock: Mitigate One-sided RDMA Lock Contention via Handover](./fast2025-gao.md)
- **作者**：Jian Gao et al.
...
#### [Oasis: An Out-of-core Approximate Graph System via All-Distances Sketches](./fast2025-yang.md)
...
#### [Maat: Analyzing and Optimizing Overcharge on Blockchain Storage](./fast2025-he.md)
- **作者**：Zheyuan He et al.
