...
#### [LeanAttention: Hardware-Aware Scalable Attention Mechanism for the Decode-Phase of Transformers](./16ec6494e9b5a4138de7238761d715b4.md)
...
#### [Flex Attention: a Programming Model for Generating Optimized Attention Kernels](./66a026c0d17040889b50f0dfa650e5e0.md)
...
#### [FlashInfer: Efficient and Customizable Attention Engine for LLM Inference Serving](./dbf02b21d77409a2db30e56866a8ab3a.md)
...
#### [SampleAttention: Near-Lossless Acceleration of Long Context LLM Inference with Adaptive Structured Sparse Attention](./2d04d97593c8c33d415337f408ed0e1b.md)
...
#### [LServe: Efficient Long-Sequence LLM Serving with Unified Sparse Attention](./cc8c6b9d89f7a898a29f58869b238e46.md)
...
#### [Context Parallelism for Scalable Million-Token Inference](./75bb91b908e6924763c9f2bbe87e921e.md)
...
#### [TurboAttention: Efficient Attention Approximation for High Throughputs LLMs](./f4f55846501f3336f293fd8b6de10770.md)
...
#### [MAS-Attention: Memory-Aware Stream Processing for Attention Acceleration on Resource-Constrained Edge Devices](./d3cf1559a8795eb1ed2b3ad52409ac7d.md)
...
#### [XGrammar: Flexible and Efficient Structured Generation Engine for Large Language Models](./5c20ca4b0b20b0bd2f1d839dc605e70f.md)
...
#### [NEO: Saving GPU Memory Crisis with CPU Offloading for Online LLM Inference](./678773d96b5822e93348aeb5c80d4dc5.md)
...
#### [FlexInfer: Flexible LLM Inference with CPU Computations](./698cfaf72a208aef2e78bcac55b74328.md)
...
#### [Marconi: Prefix Caching for the Era of Hybrid LLMs](./78834433edc3291f4c6cbbd2759324db.md)
...
#### [SOLA: Optimizing SLO Attainment for Large Language Model Serving with State-Aware Scheduling](./bc82dbfbfa43232be85b8d9838f49c3e.md)
...
#### [ThunderServe: High-Performance and Cost-Efficient LLM Serving in Cloud Environments](./c2a0e26dd9ee7d57e92bb1c24b39659a.md)
...
#### [Seesaw: High-Throughput LLM Inference via Model Re-Sharding](./cbc4ab80cd77aa0eb87da062fbcddb46.md)
...
#### [FastTree: Optimizing Attention Kernel and Runtime for Tree-Structured LLM Inference](./96894468eb44631a32d7ebd56f9892c7.md)
...
#### [Optimizing LLM Queries in Relational Data Analytics Workloads](./b5dc49f44db2fadc5c4d717c57f4a424.md)
...
#### [APOLLO: SGD-like Memory, AdamW-level Performance](./437bc4ccafd3fc6d4289bd10940be42b.md)
...
#### [HyC-LoRA: Memory Efficient LoRA Fine-tuning with Hybrid Activation Compression](./54dd9e0cff6d9214e20d97eb2a3bae49.md)
...
#### [MiLo: Efficient Quantized MoE Inference with Mixture of Low-Rank Compensators](./9032e5c9ec394ce768a2fa9bdc56af6c.md)
...
#### [QServe: W4A8KV4 Quantization and System Co-design for Efficient LLM Serving](./fbe2b2f74a2ece8070d8fb073717bda6.md)
...
#### [Self-Data Distillation for Recovering Quality in Pruned Large Language Models](./af2d9fb5bcee19ef2dfa70d843520c97.md)
...
#### [Rethinking Key-Value Cache Compression Techniques for Large Language Model Serving](./26289c647c6828e862e271ca3c490486.md)
...
#### [Efficient LLM Inference using Dynamic Input Pruning and Cache-Aware Masking](./afd6374c7f2839cba22f537f15f4f760.md)
...
#### [Enabling Unstructured Sparse Acceleration on Structured Sparse Accelerators (TASD)](./e2ec2530db26b54d0b3b060c1e4a1bda.md)
...
#### [Balancing Pipeline Parallelism with Vocabulary Parallelism](./10e400a587ff6925e4e26333b419ff55.md)
...
#### [PipeFill: Using GPUs During Bubbles in Pipeline-Parallel LLM Training](./53d3f45797970d323bd8a0d379c525aa.md)
...
#### [Scaling Deep Learning Training with MPMD Pipeline Parallelism (JaxPP)](./9f73d65a4186198152357be871345771.md)
...
#### [Rubick: Exploiting Job Reconfigurability for Deep Learning Cluster Scheduling](./270339c997293ca2988c62f4308e389f.md)
...
#### [TileLink: Generating Efficient Compute-Communication Overlapping Kernels using Tile-Centric Primitives](./c6ee784cbe46d854843e4c883a3321ef.md)
...
#### [COMET: Fine-Grained Computation-Communication Overlapping for Mixture-of-Experts](./e27ea0cd50b798ff8942caf9203f0992.md)
...
#### [Radius: Range-based Gradient Sparsity for Large Foundation Model Pre-training](./5431dca75a8d2abc1fb51e89e8324f10.md)
...
#### [Training Ultra Long Context Language Model with Fully Pipelined Distributed Transformer (FPDT)](./d5a655b8b373737b4f2aea8f78e5e754.md)
...
#### [REAL: Efficient RLHF Training of Large Language Models with Parameter Reallocation](./3b3889d313ba9476c12c2d77ea66b24f.md)
...
#### [LUMOS: Efficient Performance Modeling and Estimation for Large-Scale LLM Training](./a66caa1703fe34705a4368c3014c1966.md)
...
#### [DiffServe: Efficiently Serving Text-to-Image Diffusion Models with Query-Aware Model Scaling](./414fd191b3246a19a55741b938380136.md)
...
#### [ScaleFusion: Scalable Inference of Spatial-Temporal Diffusion Transformers for High-Resolution Long Video Generation](./a2fe4bb50fc6f3564cee1551d6309fea.md)
...
#### [VoLUT: Efficient Volumetric Streaming Enhanced by LUT-Based Super-Resolution](./f189e7580acad0fc7fd45405817ddee3.md)
...
#### [Photon: Federated LLM Pre-Training](./185087ea328b4f03ea8fd0c8aa96f747.md)
...
#### [FedProphet: Memory-Efficient Federated Adversarial Training via Robust and Consistent Cascade Learning](./96f39c8de84678cb2a908cd52bfd7819.md)
...
#### [Venn: Resource Management for Collaborative Learning Jobs](./7c180af017258d239bac6248d1eb26ac.md)
...
#### [FLStore: Efficient Federated Learning Storage for Non-Training Workloads](./f37347375d8b54e3203e5d24aeb6c58c.md)
...
#### [PROTORAIL: A Risk-Cognizant Imitation Agent for Adaptive vCPU Oversubscription in the Cloud](./42e2b24104bc92d724ce45c0c2f91e1d.md)
...
#### [LAVA: Lifetime-Aware VM Allocation with Learned Distributions and Adaptation to Mispredictions](./9de62e421d58234dbf773abf43268630.md)
...
#### [A Bring-Your-Own-Model Approach for ML-Driven Storage Placement in Warehouse-Scale Computers](./e01c431bbb83153632c0dcfaf8ccda0a.md)
...
#### [AIOpsLab: A Holistic Framework to Evaluate AI Agents for Enabling Autonomous Clouds](./d1f9e4a9f109b6e8b75ed362736f22ec.md)
...
#### [MEADOW: Memory-Efficient Dataflow and Data Packing for Low Power Edge LLMs](./259a5df46308d60f8454bd4adcc3b462.md)
...
#### [Lightweight Software Kernels and Hardware Extensions for Efficient Sparse DNNs on MCUs](./8cb5b08f912600de3de07c6503599ba8.md)
...
#### [Efficient On-Device Machine Learning with a Biologically-Plausible Forward-Only Algorithm (Bio-FO)](./b0131b6ee02a00b03fc3320176fec8f5.md)
...
#### [Pitot: Interference-Aware Edge Runtime Prediction with Conformal Matrix Completion](./40b8fb4f90004405e14b1ede6ab42373.md)
...
#### [YOUMU: Efficient Columnar Data Pipeline for LLM Training](./136b9a13861308c8948cd308ccd02658.md)
...
#### [AdaParse: An Adaptive Parallel PDF Parsing and Resource Scaling Engine](./703f727ec10190b2fddcf8e24f52df48.md)
...
#### [The Hidden Bloat in Machine Learning Systems (Negativa-ML)](./5321b1dabcd2be188d796c21b733e8c7.md)
...
#### [Supply-Chain Attacks in Machine Learning Frameworks](./7fd522b89ac21009b7bbe7560a9a5add.md)
...
#### [On Distributed Larger-Than-Memory Subset Selection With Pairwise Submodular Functions](./8144a9d62e506af0fcdeac0e456b2710.md)
...
#### [Graph Learning at Scale: Characterizing and Optimizing Pre-Propagation GNNs](./0badcb4e95306df76a719409155e46e8.md)
...
#### [GSplit: Scaling Graph Neural Network Training on Large Graphs via Probabilistic Splitting](./3619b2fc65a5538a24b48efc089da709.md)
...
#### [SparseTransX: Efficient Training of Translation-Based Knowledge Graph Embeddings Using Sparse Matrix Operations](./36e2967f87c3362e37cf988781a887ad.md)
...
#### [AI Metropolis: Scaling Large Language Model-based Multi-Agent Simulation with Out-of-Order Execution](./4f31327e046913c7238d5b671f5d820e.md)
...
#### [SwiftVI: Time-Efficient Planning and Learning with MDPs](./0f8426558905746fc38da5e335700aec.md)
...
#### [Know Where You're Uncertain When Planning with Multimodal Foundation Models](./703f727ec10190b2fddcf8e24f52df48.md)
