...
#### [[3731569.3764798|Mercury: Unlocking Multi-GPU Operator Optimization for LLMs via Remote Memory Scheduling]]
- **作者**：Yue Guan et al.
...
#### [[3731569.3764806|HedraRAG: Co-Optimizing Generation and Retrieval for Heterogeneous RAG Workflows]]
...
#### [[3731569.3764808|Characterizing Mobile SoC for Accelerating Heterogeneous LLM Inference (HeteroInfer)]]
- **作者**：Le Chen et al.
...
#### [[3731569.3764810|DiffKV: Differentiated Memory Management for Large Language Models with Parallel KV Compaction]]
...
#### [[3731569.3764814|Pie: A Programmable Serving System for Emerging LLM Applications]]
- **作者**：In Gim et al.
...
#### [[3731569.3764815|Aegaeon: Effective GPU Pooling for Concurrent LLM Serving on the Market]]
...
#### [[3731569.3764823|Jenga: Effective Memory Management for Serving LLM with Heterogeneity]]
- **作者**：Chen Zhang et al.
...
#### [[3731569.3764829|IC-Cache: Efficient Large Language Model Serving via In-context Caching]]
- **作者**：Yifan Yu et al.
...
#### [[3731569.3764834|PrefillOnly: An Inference Engine for Prefill-only Workloads]]
- **作者**：Kuntai Du et al.
...
#### [[3731569.3764843|KTransformers: Unleashing the Full Potential of CPU/GPU Hybrid Inference for MoE Models]]
...
#### [[3731569.3764855|METIS: Fast Quality-Aware RAG Systems with Configuration Adaptation]]
...
#### [[3731569.3764838|Robust LLM Training Infrastructure at ByteDance]]
- **作者**：Borui Wan et al.
...
#### [[3731569.3764839|Sailor: Automating Distributed Training over Dynamic, Heterogeneous, and Geo-distributed Clusters]]
...
#### [[3731569.3764848|Mycroft: Tracing Dependencies in Collective Communication]]
...
#### [[3731569.3764849|DCP: Addressing Input Dynamism In Long-Context Training via Dynamic Context Parallelism]]
...
#### [[3731569.3764850|TrainVerify: Equivalence-Based Verification for Distributed LLM Training]]
- **作者**：Yunchi Lu et al.
...
#### [[3731569.3764818|LithOS: An Operating System for Efficient Machine Learning on GPUs]]
...
#### [[3731569.3764840|Tempo: Compiled Dynamic Deep Learning with Symbolic Dependence Graphs]]
...
#### [[3731569.3764847|SAND: A New Programming Abstraction for Video-based Deep Learning]]
...
#### [[3731569.3764794|Rearchitecting the Thread Model of In-Memory Key-Value Stores with uTPS]]
...
#### [[3731569.3764800|How to Copy Memory? Coordinated Asynchronous Copy as a First-Class OS Service]]
- **作者**：Jingkai He et al.
...
#### [[3731569.3764807|Scalable Address Spaces using Concurrent Interval Skiplist]]
...
#### [[3731569.3764809|uFork: Supporting POSIX fork Within a Single-Address-Space OS]]
...
#### [[3731569.3764820|cache_ext: Customizing the Page Cache with eBPF]]
...
#### [[3731569.3764836|CortenMM: Efficient Memory Management with Strong Correctness Guarantees]]
...
#### [[3731569.3764842|Scalable Far Memory: Balancing Faults and Evictions]]
...
#### [[3731569.3764852|FlexGuard: Fast Mutual Exclusion Independent of Subscription]]
...
#### [[3731569.3764811|Proto: A Guided Journey through Modern OS Construction]]
...
#### [[3731569.3764796|Prove It to the Kernel: Precise Extension Analysis via Proof-Guided Abstraction Refinement (BCF)]]
- **作者**：Hao Sun et al.
...
#### [[3731569.3764797|eBPF Misbehavior Detection: Fuzzing with a Specification-Based Oracle (Veritas)]]
- **作者**：Tao Lyu et al.
...
#### [[3731569.3764817|Ghost in the Android Shell: Pragmatic Test-oracle Specification of a Production Hypervisor]]
...
#### [[3731569.3764821|Atmosphere: Practical Verified Kernels with Rust and Verus]]
...
#### [[3731569.3764822|AutoMan: Facilitating Verified Distributed Systems Development]]
...
#### [[3731569.3764856|TickTock: Verified Isolation in a Production Embedded OS]]
...
#### [[3731569.3764827|KNighter: Transforming Static Analysis with LLM-Synthesized Checkers]]
...
#### [[3731569.3764804|Sleeping with One Eye Open: Fast, Sustainable Storage with Sandman]]
- **作者**：Yanbo Zhou et al.
...
#### [[3731569.3764816|Aeolia: A Fast and Secure Userspace Interrupt-Based Storage Stack]]
...
#### [[3731569.3764857|Managing Scalable Direct Storage Accesses for GPUs with GoFS]]
- **作者**：Shaobo Li et al.
...
#### [[3731569.3768291|Analyzing and Enhancing ArckFS: An Anecdotal Example of Benefits of Artifact Evaluation]]
...
#### [[3731569.3764795|Device-Assisted Live Migration of RDMA Devices]]
...
#### [[3731569.3764801|Demeter: A Scalable and Elastic Tiered Memory Solution via Guest Delegation]]
...
#### [[3731569.3764803|Unlocking True Elasticity for the Cloud-Native Era with Dandelion]]
...
#### [[3731569.3764830|Quilt: Resource-aware Merging of Serverless Workflows]]
...
#### [[3731569.3764812|Oasis: Pooling PCIe Devices Over CXL to Boost Utilization]]
...
#### [[3731569.3764813|PhoenixOS: Concurrent OS-level GPU Checkpoint and Restore with Validated Speculation]]
- **作者**：Xingda Wei et al.
...
#### [[3731569.3764851|Tai Chi: A General High-Efficiency Scheduling Framework for SmartNICs]]
- **作者**：Bang Di et al.
...
#### [[3731569.3764802|Moirai: Optimizing Placement of Data and Compute in Hybrid Clouds]]
- **作者**：Ziyue Qiu et al.
...
#### [[3731569.3764799|Pesto: Cooking up High Performance BFT Queries]]
...
#### [[3731569.3764831|Running Consistent Applications Closer to Users with Radical]]
...
#### [[3731569.3764854|Tiga: Accelerating Geo-Distributed Transactions with Synchronized Clocks]]
...
#### [[3731569.3764805|Spirit: Fair Allocation of Interdependent Resources in Remote Memory Systems]]
...
#### [[3731569.3764824|Mantle: Efficient Hierarchical Metadata Management for Cloud Object Storage]]
- **作者**：Jiahao Li et al.
...
#### [[3731569.3764826|The Design and Implementation of a Virtual Firmware Monitor (Miralis)]]
...
#### [[3731569.3764828|Tock: From Research to Securing 10 Million Computers]]
...
#### [[3731569.3764844|CHERIoT RTOS: An OS for Fine-Grained Memory-Safe Compartments on Low-Cost Embedded Devices]]
- **作者**：Saar Amar et al.
...
#### [[3731569.3764837|TRIP: Coercion-resistant Registration for E-Voting (Votegral)]]
...
#### [[3731569.3764833|Orq: Complex Analytics on Private Data with Strong Security Guarantees]]
- **作者**：Eli Baum et al.
...
#### [[3731569.3764832|Orthrus: Efficient and Timely Detection of Silent User Data Corruption]]
...
#### [[3731569.3764835|Mitigating Application Resource Overload with Targeted Task Cancellation (Atropos)]]
- **作者**：Yigong Hu et al.
...
#### [[3731569.3764858|Optimistic Recovery for High-Availability Software via Partial Process State Preservation (PHOENIX)]]
...
#### [[3731569.3764841|Fawkes: Finding Data Durability Bugs in DBMSs via Recovered Data State Verification]]
- **作者**：Zhiyong Wu et al.
...
#### [[3731569.3764853|Loom: Efficient Capture and Querying of High-Frequency Telemetry]]
...
#### [[3731569.3764819|WASIT: Deep and Continuous Differential Testing of WebAssembly System Interface]]
- **作者**：Yage Hu et al.
...
#### [[3731569.3764846|COpter: Efficient Large-Scale Resource-Allocation via Continual Optimization]]
...
#### [[3731569.3764825|Fast End-to-End Performance Simulation of Accelerated Hardware-Software Stacks (NEX+DSim)]]
...
#### [[3731569.3764845|Coyote v2: Raising the Level of Abstraction for Data Center FPGAs]]
