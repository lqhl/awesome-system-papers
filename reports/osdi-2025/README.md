...
#### [NanoFlow: Towards Optimal Large Language Model Serving Throughput](./osdi25-zhu-kan.md)
- **作者**：Kan Zhu et al.
...
#### [WaferLLM: Large Language Model Inference at Wafer Scale](./osdi25-he.md)
- **作者**：Congjie He et al.
...
#### [DecDEC: A Systems Approach to Advancing Low-Bit LLM Quantization](./osdi25-park-yeonhong.md)
...
#### [BLITZSCALE: Fast and Live Large Model Autoscaling with O(1) Host Caching](./osdi25-zhang-dingyan.md)
...
#### [WLB-LLM: Workload-Balanced 4D Parallelism for Large Language Model Training](./osdi25-wang-zheng.md)
...
#### [Understanding Stragglers in Large Model Training Using What-if Analysis](./osdi25-lin-jinkun.md)
...
#### [Training with Confidence: Catching Silent Errors in Deep Learning Training](./osdi25-jiang.md)
...
#### [Enabling Efficient GPU Communication over Multiple NICs with FuseLink](./osdi25-ren.md)
...
#### [ZEN: Empowering Distributed Training with Sparsity-driven Data Synchronization](./osdi25-wang-zhuang.md)
...
#### [PipeThreader: Software-Defined Pipelining for Efficient DNN Execution](./osdi25-cheng.md)
...
#### [Mirage: A Multi-Level Superoptimizer for Tensor Programs](./osdi25-wu-mengdi.md)
...
#### [QiMeng-Xpiler: Transcompiling Tensor Programs for Deep Learning Systems](./osdi25-dong.md)
...
#### [Bayesian Code Diffusion for Efficient Automatic Deep Learning Program Optimization](./osdi25-jeong.md)
- **作者**：Isu Jeong et al.
...
#### [XSched: Preemptive Scheduling for Diverse XPUs](./osdi25-shen-weihang.md)
...
#### [KPerfIR: Towards an Open and Compiler-centric Ecosystem for GPU Kernel Performance Tooling](./osdi25-guan.md)
- **作者**：Yue Guan et al.
...
#### [NEUTRINO: Fine-grained GPU Kernel Profiling via Programmable Probing](./osdi25-huang-songlin.md)
...
#### [Tintin: A Unified Hardware Performance Profiling Infrastructure](./osdi25-li.md)
- **作者**：Ao Li et al.
...
#### [Okapi: Decoupling Data Striping and Redundancy Grouping in Cluster File Systems](./osdi25-athlur.md)
...
#### [Stripeless Data Placement for Erasure-Coded In-Memory Storage](./osdi25-gao.md)
- **作者**：Jian Gao et al.
...
#### [Scalio: Scaling up DPU-based JBOF Key-value Store with NVMe-oF Target Offload](./osdi25-sun.md)
- **作者**：Xun Sun et al.
...
#### [Decentralized, Epoch-based F2FS Journaling with Fine-grained Crash Recovery](./osdi25-cui.md)
...
#### [Fast and Synchronous Crash Consistency with Metadata Write-Once File System](./osdi25-pan.md)
- **作者**：Yanqi Pan et al.
...
#### [PoWER Never Corrupts: Tool-Agnostic Verification of Crash Consistency](./osdi25-leblanc.md)
...
#### [Tiered Memory Management Beyond Hotness](./osdi25-liu.md)
- **作者**：Jinshu Liu et al.
...
#### [EMT: An OS Framework for New Memory Translation Architectures](./osdi25-chai-siyuan.md)
...
#### [FineMem: Breaking the Allocation Overhead vs. Memory Waste Dilemma](./osdi25-wang-xiaoyang.md)
...
#### [Tigon: A Distributed Database for a CXL Pod](./osdi25-huang-yibo.md)
- **作者**：Yibo Huang et al.
...
#### [Söze: One Network Telemetry Is All You Need for Per-flow Weighted Bandwidth Allocation](./osdi25-wang-weitao.md)
...
#### [rxBisect: Disentangling the Dual Role of NIC Receive Rings](./osdi25-pismenny.md)
...
#### [Skybridge: Bounded Staleness for Distributed Caches](./osdi25-lyerly.md)
...
#### [Picsou: Enabling Replicated State Machines to Communicate Efficiently](./osdi25-frank.md)
...
#### [Low End-to-End Latency atop a Speculative Shared Log with Fix-Ante Ordering](./osdi25-bhat.md)
...
#### [Mako: Speculative Distributed Transactions with Geo-Replication](./osdi25-shen-weihai.md)
...
#### [Kamino: Efficient VM Allocation at Scale with Latency-Driven Cache-Aware Scheduling](./osdi25-domingo.md)
...
#### [Decouple and Decompose: Scaling Resource Allocation with DeDe](./osdi25-xu.md)
- **作者**：Zhiying Xu et al.
...
#### [PipeANN: Achieving Low-Latency Graph-Based Vector Search via Aligning Best-First Search with SSD](./osdi25-guo.md)
- **作者**：Hao Guo et al.
...
#### [Quake: Adaptive Indexing for Vector Search](./osdi25-mohoney.md)
...
#### [Compass: Encrypted Semantic Search with High Accuracy](./osdi25-zhu-jinhao.md)
- **作者**：Jinhao Zhu et al.
...
#### [Fork in the Road: Reflections and Optimizations for Cold Start Latency in Serverless Systems](./osdi25-chai-xiaohu.md)
...
#### [MettEagle: Costs and Benefits of Implementing Containers on Microkernels](./osdi25-miemietz.md)
...
#### [Paralegal: Practical Static Analysis for Privacy Bugs](./osdi25-adam.md)
...
#### [Weave: Efficient and Expressive Oblivious Analytics at Scale](./osdi25-soleimani.md)
...
#### [Omniglot: Building Bridges — Safe Interactions with Foreign Languages](./osdi25-schuermann.md)
...
#### [Basilisk: Using Provenance Invariants to Automate Proofs of Undecidable Protocols](./osdi25-zhang-tony.md)
...
#### [Deterministic Client: Enforcing Determinism on Untrusted Machine Code](./osdi25-yedidia.md)
...
#### [T2C: Deriving Semantic Checkers from Tests to Detect Silent Failures](./osdi25-lou.md)
- **作者**：Chang Lou et al.
...
#### [KRR: Efficient and Scalable Kernel Record Replay](./osdi25-zhang-tianren.md)
...
#### [QOS: Quantum Operating System](./osdi25-giortamis.md)
...
#### [Quantum Virtual Machines](./osdi25-tao.md)
...
#### [To PRI or Not To PRI: Device Passthrough Memory Management](./osdi25-wang-yun.md)
...
#### [OS Rendering Service Made Parallel](./osdi25-wu-yuanpei.md)
- **作者**：Yuanpei Wu et al.
...
#### [Extending Applications Safely and Efficiently](./osdi25-zheng-yusheng.md)
...
#### [Principles and Methodologies for Serial Performance Optimization](./osdi25-park-sujin.md)
- **作者**：Sujin Park et al.
