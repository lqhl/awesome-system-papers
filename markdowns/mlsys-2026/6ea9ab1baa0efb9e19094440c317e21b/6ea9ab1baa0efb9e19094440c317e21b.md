...
<table><tr><td></td><td>BPF APIs</td><td>Description</td></tr><tr><td rowspan="9">rrresgeeger</td><td>bpf_ktime-get_ns</td><td>Get the timestamp</td></tr><tr><td>bpf-get_current-pid_tgid</td><td>Get pid and tid</td></tr><tr><td>bpf-get_smp-processor_id</td><td>Get cpu id</td></tr><tr><td>bpf-probe_read_user(kernel)</td><td>Read user/kernel address space</td></tr><tr><td>map.lookup</td><td>Query a BPF map</td></tr><tr><td>map.update</td><td>Update a BPF map</td></tr><tr><td>map.perf_read</td><td>Read the value of aPMC</td></tr><tr><td>ringbuf(perf)-submit</td><td>Submit a ring(perf) buffer</td></tr><tr><td></td><td>Attach probeswhen a user-space</td></tr><tr><td rowspan="5">eess geee</td><td>attach_u(ret)probe</td><td>function is invoked or returned</td></tr><tr><td>attach_tracepoint</td><td>Attach a kernel trace point</td></tr><tr><td>open-perf_event</td><td>Create a fd to monitorPMC</td></tr><tr><td>perf(ring)_buffer_poll</td><td>Poll the submitted perf(ring) buffer</td></tr><tr><td></td><td></td></tr></table>
...
<table><tr><td>Probed functions</td><td>Type</td><td>Level</td><td>Traced information</td></tr><tr><td>llama_decode</td><td>u(ret)probe</td><td>Token</td><td>batch size</td></tr><tr><td>ggml_backend-graph</td><td>u(ret)probe</td><td>Graph</td><td>backend type</td></tr><tr><td>-compute_async</td><td>u(ret)probe</td><td>OP(CPU)</td><td>tensor info,PMC</td></tr><tr><td>ggml_compute_forward</td><td>u(ret)probe</td><td>OP(GPU)</td><td>tensor info</td></tr><tr><td>ggml_cl_compute_forward ggml_rk_compute_forward</td><td>u(ret)probe</td><td>OP(NPU)</td><td>tensor info</td></tr><tr><td></td><td></td><td></td><td></td></tr><tr><td>sched_switch</td><td>tracepoint</td><td>kernel</td><td>thread IDs</td></tr><tr><td>sched_wakeup</td><td>tracepoint</td><td>kernel</td><td>thread IDs</td></tr></table>
...
<table><tr><td>PMC</td><td>Type</td><td>Description</td><td>Unit</td></tr><tr><td>13d_cache_refill</td><td>per-core</td><td>Read from memory (A76)</td><td>64B</td></tr><tr><td>mem_access_wr</td><td>per-core</td><td>Write into memory(A76)</td><td>16B</td></tr><tr><td>major-faults</td><td>software</td><td>Major page faults</td><td>1 Page</td></tr><tr><td>cycles</td><td>hardware</td><td>CPU cycles</td><td>1 Cycle</td></tr><tr><td>idle-backend-cycles</td><td>hardware</td><td>stalled CPU cycles at backend</td><td>1 Cycle</td></tr></table>
...
Input: $d f _ { r a w } \colon$ a table with all raw buffer entries   
$n _ { t a r } \colon$ target decoding iteration   
Output: graph: a ProfDAG given of LLM   
1 dfs ops $\ i  \{ \} ;$   
2 foreach $d f _ { t i d }$ in dfraw.groupby(tid) do   
3 dftid $\gets d f _ { t i d }$ .sorted(by = timestamp);   
4 $d f _ { - } o p s _ { t i d } ^ { i t e r }  d f _ { t i d } [ f u n c = = o p \land n _ { i t e r } = = n _ { t a r } ]$   
...
15 foreach $o p _ { p r e }$ in dfs ops $[ 0 ] [ s r c ^ { \prime } ]$ do   
16 if $o p _ { p r e }$ not in graph.nodes then   
17 graph.add node $( o p _ { p r e } ) ;$   
18 graph.add edge(oppre, opcur);   
19 return graph;   
Avg. memory bandwidth (MB/s) 2 × 104 27 [8192,1, 1] 28   
0192.   
[2048,1. 1] 26 [2048, 1, 1] [8192, 1, 1] [8192, 1, 1] 29 30 31   
10 4 12048.1, 25 12048.1.1   
24 [2048, 1, 1] 32   
...
<table><tr><td>Device</td><td>SoC</td><td>RAM</td><td>OS</td></tr><tr><td>Orange Pi 5 Plus</td><td>RK3588</td><td>32G LPDDR4/4X</td><td>OpenHarmony 5.1.0</td></tr><tr><td>Orange Pi 5 Ultra</td><td>RK3588</td><td>8G LPDDR5</td><td>Ubuntu 22.04.5</td></tr><tr><td>RUBIK Pi 3</td><td>QCS6490</td><td>8G LPDDR4X</td><td>Ubuntu 24.04</td></tr></table>
...
<table><tr><td>Plat.</td><td>Str.</td><td>PMC</td><td>P-buf.</td><td>Speed dec.</td><td>CPU load P.</td></tr><tr><td rowspan="7">PCC</td><td>&lt;x&lt;√</td><td>√</td><td></td><td>4.0</td><td>0.70</td></tr><tr><td></td><td>√</td><td></td><td>3.6</td><td>0.66</td></tr><tr><td></td><td></td><td></td><td>3.4</td><td>0.69</td></tr><tr><td></td><td></td><td></td><td>3.1</td><td>0.62</td></tr><tr><td>×</td><td>x&lt;/</td><td>&lt;/&lt;xx/x</td><td>3.3</td><td>0.63</td></tr><tr><td>x√</td><td>×</td><td></td><td>3.3</td><td>0.63</td></tr><tr><td></td><td>×</td><td></td><td>3.0</td><td>0.62</td></tr><tr><td></td><td>X</td><td>X</td><td>X</td><td>2.8</td><td>0.61</td></tr><tr><td rowspan="2">Jdqq!</td><td>√</td><td>X</td><td>X</td><td>2.2</td><td>0.41</td></tr><tr><td>X</td><td>X</td><td>X</td><td>1.7</td><td>0.41</td></tr></table>
...
Overhead of ProfInfer. To analyze the online overhead caused by ProfInfer, we used bpftool to collect the cost of every probe. Besides, as the decoding stage is memoryintensive, the message passing and logging of the tracer can also lead to a degradation of the decoding speed. Table 5 summarizes the relative decrease in the decoding speed and the average CPU load costed by the probes w.r.t. the runtime (e.g., we observed the CPU load when using 4 threads is always 400%, then the average CPU load of the probes on each core is equal to $\sum ( t _ { p r o b e } ) / ( t _ { r u n t i m e } \times 4 ) \AA ^ { \prime }$ ). Specifically, there is no impact on the prefill stage.
...
<table><tr><td colspan="6">llama_decode</td></tr><tr><td colspan="7">graph_comp_cpu</td></tr><tr><td>MUL_MAT-Qcur-0</td><td></td><td>MM</td><td>MUL_MAT-kq..</td><td></td><td>MUL_MAT-ffn_gate-0</td><td>MUL_MAT-ffn_up-0</td></tr><tr><td></td><td>MUL_MAT-Qcur-0</td><td>M_ M</td><td>MUL_MAT-qv_.</td><td></td><td>MUL_MAT-ffn_gate-0</td><td>MUL_MAT-ffn_up-0</td></tr><tr><td></td><td>MUL_MAT-Qcur-0</td><td>M</td><td>MUL_MAT-qv..</td><td></td><td>MUL_MAT-ffn_gate-0</td><td>MUL_MAT-ffn_up-0</td></tr><tr><td></td><td>MUL_MAT-Qcur-0</td><td>M. M</td><td>MUL_MAT-kqv_</td><td></td><td>MUL_MAT-ffn_gate-0</td><td>MUL_MAT-ffn_up-0</td></tr></table>
...
Figure 10. The execution time of the operator matrix multiplication in the first decoding iteration with 2 Cortex-A76 CPUs as the backend. The x-axis represents the computational complexity, i.e., $\mathcal { O } ( M \times N \times K \times H )$ , given a matrix multiplication ${ \cal A } _ { ( M , K ) } \times$ $B _ { ( K , N ) }$ . KQ and KQV also introduce the dimension of attention heads H. M is 1 in the decoding stage.  
