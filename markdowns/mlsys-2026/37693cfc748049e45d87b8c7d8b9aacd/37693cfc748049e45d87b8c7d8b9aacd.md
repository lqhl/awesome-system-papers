...
![](images/ecf9f398fc3332a76926572b7c4fa34e8d61aa805d1ff72c4ebf283704c0e88d.jpg)
...
• Hierarchical Fabrics (NVIDIA HGX/Spine-Leaf/Fat Tree): Levels map directly to switch tiers and link types. For example, l0 represents intra-node NVLink (e.g., 900 GB/s for H100), while l1 and l2 capture the significant bandwidth asymmetry of inter-node Ethernet/InfiniBand and oversubscribed inter-rack Spine-Leaf links. This allows the DP to avoid placing high-bandwidth pipeline stages across oversubscribed boundaries.

• Non-Uniform Meshes (TPUv4 Torus): In torus-based systems, levels represent hop-distance or coordinateaffinity classes (e.g., l0: same tile, l1: 1-hop, l2: remote). By mapping these to profiled latencies, NEST accounts for non-uniform communication costs when scaling to thousands of accelerators.
...
![](images/a3a41e812621b844cc40c41a960208f14c90cc2a3a1639a8d734b95ed8d2baa9.jpg)
...
![](images/60e633a1b60164bcdacdf5739cb3d9939449f8b8da320a2113d59604a48fa93a.jpg)
...
![](images/5dc7ea7f52102663f851be68286c737f7ee19b9725457e0500c004eb7cc83a3c.jpg)
...
![](images/fa49e77fd5b71542878d77084747260cf4670b5d2e1e400e5c7f21cdad3b3b6f.jpg)
...
![](images/d514d35753549820e62a3b2abb8f9317d194a587156d9774d2bdb1a4d171d61d.jpg)
...
![](images/2feb71368cd3b52af35c864d714340ee18a87708dca80765ec4c87bfd8d835ea.jpg)
...
1: Init: dp[ℓ][id][k][s] ← (∞, ∅) // dp[level][downset][accelerators][stages]   
2: dp[ℓ][∅][∗][0] ← (0, init) // Base case: no layers assigned   
3: for id ∈ Downsets \ {Dfull} do   
...
12: dp[ℓ][id][k][s].first ← c // Update min-max latency   
13: end if   
14: end for   
15: end for   
16: end for   
17: end for   
18: tmin ← ∞ // Find best end-to-end batch time   
19: for subId ⊂ Dfull, F ← Dfull \ subId do   
20: load ← GETLOADOFSTAGE(F, subId) // Latency for remaining layers   
21: for s ∈ [1, Smax], k ∈ [1, Kmax], a ∈ VALIDACCELCOUNTS(F ) do   
