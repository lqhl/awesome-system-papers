...
![](images/d0bc64d669faeba8347ccd531572ad4fb0e6ee892e57e02545078c685e243786.jpg)  
...
![](images/992846a4de8ed2435324115e2562dbbcd3e5c80aba81945634b7709dbd811ab5.jpg)  
...
![](images/b603ac7142118c2d1bd999d777c965b3e13f611080c09ee0692c8ce4da09b24a.jpg)  
...
![](images/a990efb536bf557d6c0a5a31208ab4fac2444d06473997f33f2c615357d1cd88.jpg)  
Figure 4. Event Tensor handles shape dynamism with symbolicshape tensors that define a template for dependency graphs. At runtime, the template is instantiated with concrete shape values (e.g., producing a 1 × 2 graph for batch size 1 or a $2 \times 2$ graph for batch size 2) without recompilation or repeated graph capture.

## 2.2 Representing Fine-Grained Dependencies

To illustrate how Event Tensors are used in practice, we walk through the example shown in Figure 3. It shows a task graph that performs a summation over the inner axis of the input tensor A, which has symbolic shape $( n \times 3 2 , 1 2 8 )$ : $\begin{array} { r } { C [ i ] \ = \ \sum _ { k \in [ 0 , 1 2 8 ) } A [ i , k ] } \end{array}$ The example adopts a split-K algorithm that divides the summation into two stages $\begin{array} { r } { B [ i , j ] \ = \ \sum _ { k \in [ j * 3 2 , j * 3 2 + 3 2 ) } A [ i , k ] } \end{array}$ and $\begin{array} { r } { C [ i ] = \sum _ { k \in [ 0 , 4 ) } B [ i , k ] } \end{array}$ , where the first stage computes partial sums of each row into $B ,$ and the second stage aggregates them to produce C. In a traditional kernel-by-kernel approach, tasks in the second stage are launched only after all tasks in the first stage have completed. However, each output row $C [ i ]$ depends only on the corresponding row $B [ i , : ]$ , meaning that its computation can proceed concurrently with partial sums of other rows. To capture this fine-grained dependency, we partition the computations of B and C into finer tasks and introduce an Event Tensor E:

$$
\begin{array} { r l r } { \operatorname { T a s k } \hat { B } _ { i , j } \colon } & { \quad } & { B [ i * 3 2 : i * 3 2 + 3 2 , j ] , } \\ { \operatorname { E v e n t } E _ { i } \colon } & { } & { E [ i ] , } \\ { \operatorname { T a s k } \hat { C } _ { i } \colon } & { } & { C [ i * 3 2 : i * 3 2 + 3 2 ] . } \end{array}
$$

![](images/ee1b8c8d6f97d6f15343ad859897f35ddfbcf6fe546cde30636069efec9ac3c9.jpg)  
...
With task partitioning, the dependency relations becomes ${ \hat { B } } _ { i , j } \to E _ { i } ( { \hat { B } } _ { i , j }$ produces $E _ { i } )$ and $E _ { i }  \hat { C } _ { i } ( \hat { C } _ { i } $ consumes $E _ { i } )$ , where each $E _ { i }$ corresponds to the completion of 32 consecutive rows of B starting from row $3 2 * i$
...
![](images/0a09f000206c9e647dab9cd94e3b0ce0b2a8af8456b6237a99ee840117cd8935.jpg)  
...
![](images/c8512872c99e9494acb0c21f623753fb2c3c0658edcfaf7886a6d7cf7d41b04e.jpg)  
...
![](images/fa03241b60233a82821e752940080239ed5db96bc66c0f83c6e6117f6072d385.jpg)  
...
![](images/aeadd17154e958b5ddd84c75397251e7b4c1d30897947e97405d66598b7311e0.jpg)  
...
![](images/27c854f3549bb5b354efde29c4982881e6fda75467098679b0aa668caae0c5d4.jpg)

![](images/cdf8c88803e575ab1d4528bf6f04778bffcccb6edb860bf1883a47fb9c1ec441.jpg)

![](images/284e68257a7b62f271955ebc0fe0540430d9a5bceb43e2fb73f6c16139313958.jpg)  
...
<table><tr><td>Method</td><td>Warmup Time (s)</td><td># JITGraph Capture</td></tr><tr><td>SGLang (JIT)</td><td>583</td><td>51</td></tr><tr><td>vLLM (JIT)</td><td>123</td><td>67</td></tr><tr><td>ETC (AOT)</td><td>35</td><td>0</td></tr></table>
...
<table><tr><td>Num tokens</td><td>1</td><td>128</td><td>1024</td><td>4096</td></tr><tr><td>Static</td><td>1.03</td><td>1.02</td><td>1.04</td><td>1.02</td></tr><tr><td>Dynamic</td><td>0.95</td><td>1.06</td><td>1.08</td><td>1.03</td></tr></table>
...
<table><tr><td>Batch Size</td><td>1</td><td>16</td><td>32</td><td>128</td></tr><tr><td>Static</td><td>1.09</td><td>1.06</td><td>1.07</td><td>1.06</td></tr><tr><td>Dynamic</td><td>0.83</td><td>0.82</td><td>0.85</td><td>0.89</td></tr></table>
...
![](images/a6f501af45c0696af0ed9d909c3ea7e0a6906a33da28127b56251524add318ba.jpg)  
...
<table><tr><td colspan="5">MLP Configurations</td></tr><tr><td>Name</td><td>Source Model</td><td>S</td><td>H</td><td>I</td></tr><tr><td>MLP-1</td><td>Qwen3-8B</td><td>8192</td><td>4096</td><td>12288</td></tr><tr><td>MLP-2</td><td>LLaMA-3.1-8B</td><td>8192</td><td>4096</td><td>14336</td></tr><tr><td>MLP-3</td><td>Gemma-2-9B</td><td>8192</td><td>3584</td><td>14336</td></tr><tr><td>MLP-4</td><td>Gemma-2-27B</td><td>8192</td><td>4608</td><td>36864</td></tr><tr><td>MLP-5</td><td>Qwen3-32B</td><td>8192</td><td>5120</td><td>25600</td></tr><tr><td>MLP-6</td><td>LLaMA-3.1-70B</td><td>8192</td><td>8192</td><td>28672</td></tr><tr><td>MLP-7</td><td>GPT-3-175B</td><td>8192</td><td>12288</td><td>49152</td></tr><tr><td>MLP-8</td><td>LLaMA-3.1-405B</td><td>8192</td><td>16384</td><td>53248</td></tr></table>

![](images/944fb83866495034e7e3640543900c8f18a438011f82120dc70b4a1ae3ed487c.jpg)

Figure 16. Raw kernel relative performance results of Qwen-30B-A3B on a single B200.  
![](images/ef1b0e99397156e2320fc1a625cc7304a5594ec8a83f7c628ccfb2ea64433e84.jpg)  
