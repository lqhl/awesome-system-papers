...
<table><tr><td>Model</td><td>Task</td><td>FP16</td><td>KIVI-4bit</td><td>KIVI-2bit</td></tr><tr><td rowspan="5">guamo 18-</td><td>GSM8K</td><td>94.79</td><td>94.41</td><td>89.13</td></tr><tr><td>MATH</td><td>88.26</td><td>88.46</td><td>47.29</td></tr><tr><td>GPQA</td><td>40.71</td><td>38.98</td><td>32.24</td></tr><tr><td>HumanEval</td><td>84.82</td><td>84.09</td><td>76.89</td></tr><tr><td>AIME24 AIME25</td><td>71.67 66.00</td><td>77.67</td><td>57.00</td></tr><tr><td rowspan="4">TTAAAA 18-</td><td>GSM8K</td><td>76.75</td><td>65.33 76.09</td><td>52.33 63.58</td></tr><tr><td>MATH</td><td>47.15</td><td>47.85</td><td>31.45</td></tr><tr><td>GPQA</td><td>26.94</td><td>25.82</td><td></td></tr><tr><td>HumanEval</td><td>63.96</td><td>62.07</td><td>23.88 55.30</td></tr></table>
...
<table><tr><td>Model</td><td>Task</td><td>FP16</td><td>KIVI-K2V2</td><td>KIVI-K2V2*</td><td>KIVI-K2V4*</td><td>KIVI-K4V2*</td></tr><tr><td rowspan="6">Qwen3-8B</td><td>GSM8K</td><td>94.79</td><td>89.13</td><td>89.71</td><td>90.14</td><td>93.96</td></tr><tr><td>MATH</td><td>88.26</td><td>47.29</td><td>74.92</td><td>82.50</td><td>87.92</td></tr><tr><td>GPQA</td><td>40.71</td><td>32.24</td><td>36.02</td><td>35.82</td><td>40.51</td></tr><tr><td>HumanEval</td><td>84.82</td><td>76.89</td><td>78.54</td><td>81.77</td><td>83.41</td></tr><tr><td>AIME24</td><td>71.67</td><td>57.00</td><td>67.67</td><td>71.00</td><td>76.00</td></tr><tr><td>AIME25</td><td>66.00</td><td>52.33</td><td>57.67</td><td>64.33</td><td>64.33</td></tr><tr><td rowspan="4">LLaMA3-8B</td><td>GSM8K</td><td>76.75</td><td>63.58</td><td>71.04</td><td>72.38</td><td>76.62</td></tr><tr><td>MATH</td><td>47.15</td><td>31.45</td><td>44.12</td><td>44.09</td><td>48.41</td></tr><tr><td>GPQA</td><td>26.94</td><td>23.88</td><td>23.67</td><td>24.80</td><td>25.20</td></tr><tr><td>HumanEval</td><td>63.96</td><td>55.30</td><td>56.71</td><td>59.02</td><td>62.80</td></tr></table>
...
$$
{ \mathrm { a t t n . s c o r e } } = { \mathrm { s o f t m a x } } \left( { \frac { Q K ^ { \top } } { \sqrt { d } } } \right) .\tag{1}
$$
...
$$
s _ { i } = \frac { 1 } { T } \sum _ { t = 1 } ^ { T } \left| x _ { i , t } \right| .\tag{2}
$$
...
We store all 2-bit channels and the lower two bits of boosted 4-bit channels in a dense tensor, Tensor 2bits, of shape (D, G). As shown in the lower part of Figure 3a, the higher two bits of boosted channels form a 2-bit sparse tensor. For memory efficiency, we compactly store only the nonzero channels of this sparse tensor, resulting in Tensor High 2bits of shape $( D _ { \mathrm { b o o s t } } , G )$ , where $D _ { \mathrm { b o o s t } }$ denotes the number of channels promoted to 4-bit precision.

To reconstruct the full tensor, we maintain an index tensor Boost IDX uint8 with shape (D, ), defining a mapping $1 , 2 , \ldots , D  1 , 2 , \ldots , D _ { \mathrm { b o o s t } }$ that maps each logical channel index to its physical offset in GPU memory. For channels not boosted to INT4 precision, the corresponding index is set to a sentinel value of $D _ { \mathrm { b o o s t } } + 1$
...
<table><tr><td colspan="2">Model /Method</td><td>GSM8K</td><td>MATH ALGEBRA</td><td>HUMAN EVAL</td><td>GPQA DIAMOND</td><td>Average</td><td>Drop</td></tr><tr><td rowspan="4">Qwen3-8B</td><td>K16V16</td><td> $\mathbf { 9 4 . 7 9 } \mathrm { \pm _ { 0 . 7 1 } }$ </td><td> $\mathbf { 8 8 . 2 6 } \pm _ { 0 . 4 5 }$ </td><td> $\mathbf { 8 4 . 8 2 } \pm _ { 3 . 7 2 }$ </td><td> $\mathbf { 4 0 . 7 1 } { \scriptstyle \pm _ { 2 . 9 6 } }$ </td><td>77.15</td><td>1</td></tr><tr><td>KIVI-K2V2</td><td> $8 9 . 1 3 { \scriptstyle \pm 0 . 5 1 }$ </td><td> $4 7 . 2 9 { \scriptstyle \pm 0 . 2 0 }$ </td><td> $7 6 . 8 9 { \scriptstyle \pm _ { 3 . 1 1 } }$ </td><td> $3 2 . 2 4 { \scriptstyle \pm _ { 3 . 1 6 } }$ </td><td>61.39</td><td>-15.76</td></tr><tr><td>KIVI-K2V2*</td><td> $8 9 . 7 1 { \scriptstyle \pm _ { 0 . 6 3 } }$ </td><td> $7 4 . 9 2 { \scriptstyle \pm 1 . 8 3 }$ </td><td> $7 8 . 5 4 { \scriptstyle \pm 2 . 5 6 }$ </td><td> $3 6 . 0 2 { \scriptstyle \pm } _ { 3 . 2 7 }$ </td><td>69.80</td><td>-7.35</td></tr><tr><td>Kitty</td><td> $9 3 . 6 1 { \pm } _ { 0 . 5 8 }$ </td><td> $8 5 . 1 2 { \scriptstyle \pm 1 . 5 4 }$ </td><td> $8 1 . 7 7 { \scriptstyle \pm 1 . 8 9 }$ </td><td> $3 9 . 3 9 { \scriptstyle \pm _ { 4 . 1 8 } }$ </td><td>74.97</td><td> -2.18</td></tr><tr><td rowspan="4">Qwen3-14B</td><td> Kitty-Pro</td><td> $9 4 . 3 4 \pm _ { 0 . 4 8 }$ </td><td> $8 8 . 1 2 { \scriptstyle \pm _ { 1 . 2 6 } }$ </td><td> $8 1 . 3 4 \pm _ { 3 . 4 1 }$ </td><td> $4 0 . 9 2 { \scriptstyle \pm } _ { 5 . 0 0 }$ </td><td>76.18</td><td>-0.97</td></tr><tr><td>K16V16</td><td> $\mathbf { 9 4 . 6 9 } \pm _ { 0 . 4 5 }$ </td><td> $\mathbf { 9 0 . 6 8 } \pm _ { 0 . 1 4 }$ </td><td> $\mathbf { 8 6 . 1 8 } \pm _ { 2 . 0 3 }$ </td><td> $4 7 . 6 2 { \scriptstyle \pm 3 . 7 4 }$ </td><td>79.79</td><td>1</td></tr><tr><td>KIVI-K2V2</td><td> $7 5 . 8 2 { \scriptstyle \pm 1 . 9 7 }$ </td><td> $8 3 . 6 6 \pm _ { 1 . 0 1 }$ </td><td> $8 3 . 7 4 \pm _ { 0 . 4 1 }$ </td><td> $4 1 . 5 0 { \scriptstyle \pm 0 . 3 4 }$ </td><td>71.18</td><td>-8.61</td></tr><tr><td>KIVI-K2V2*</td><td> $8 9 . 5 6 { \scriptstyle \pm _ { 0 . 9 4 } }$ </td><td> $8 3 . 7 4 { \scriptstyle \pm 0 . 5 9 }$ </td><td> $8 5 . 9 8 { \scriptstyle \pm 1 . 8 3 }$ </td><td> $4 5 . 2 4 { \scriptstyle \pm _ { 2 . 8 9 } }$ </td><td>76.13</td><td>-3.66</td></tr><tr><td rowspan="4">Qwen3-32B</td><td>Kitty</td><td> $9 4 . 6 7 { \scriptstyle \pm 0 . 9 4 }$ </td><td> $9 0 . 3 1 { \pm } _ { 0 . 9 3 }$ </td><td> $8 8 . 2 1 { \scriptstyle \pm _ { 2 . 2 4 } }$ </td><td> $4 7 . 1 1 \pm _ { 4 . 2 5 }$ </td><td>80.08</td><td>0.29</td></tr><tr><td>K16V16</td><td> $\mathbf { 9 1 . 7 4 } { \scriptstyle \pm _ { 0 . 9 9 } }$ </td><td> $\mathbf { 8 4 . 8 4 } \pm _ { 0 . 9 3 }$ </td><td> $\mathbf { 8 5 . 9 8 } \pm _ { 1 . 2 2 }$ </td><td> ${ \bf 4 8 . 8 1 \pm _ { 1 . 8 7 } }$ </td><td>77.84</td><td>1</td></tr><tr><td>KIVI-K2V2 KIVI-K2V2*</td><td> $8 8 . 1 7 { \scriptstyle \pm _ { 0 . 3 8 } }$ </td><td> $5 9 . 7 0 { \scriptstyle \pm _ { 0 . 8 1 } }$ </td><td> $8 4 . 7 6 { \scriptstyle \pm _ { 0 . 6 1 } }$ </td><td> $4 4 . 2 2 { \scriptstyle \pm _ { 1 . 1 9 } }$ </td><td>69.21</td><td>-8.63</td></tr><tr><td>Kitty</td><td> $8 9 . 3 1 { \scriptstyle \pm _ { 0 . 9 1 } }$   $9 1 . 5 6 { \scriptstyle \pm _ { 0 . 5 8 } }$ </td><td> $7 4 . 9 2 { \scriptstyle \pm _ { 0 . 4 5 } }$   $8 3 . 8 0 { \scriptstyle \pm _ { 0 . 6 2 } }$ </td><td> $8 5 . 3 7 { \scriptstyle \pm 2 . 4 4 }$   $8 6 . 2 8 { \scriptstyle \pm } _ { 5 . 7 9 }$ </td><td> $4 8 . 9 8 { \scriptstyle \pm _ { 2 . 5 5 } }$   $4 7 . 4 5 { \scriptstyle \pm 1 . 0 2 }$ </td><td>74.65 77.27</td><td>-3.19</td></tr><tr><td rowspan="5">LLaMA3.1-8B-Instruct</td><td>K16V16</td><td></td><td></td><td></td><td></td><td></td><td>-0.57</td></tr><tr><td>KIVI-K2V2</td><td> $7 6 . 7 5 { \scriptstyle \pm 1 . 1 6 }$ </td><td> ${ \bf 4 7 . 1 5 bot } _ { 0 . 4 8 }$ </td><td> ${ \bf 6 3 . 9 6 { \scriptstyle \pm _ { 3 . 1 1 } } }$ </td><td> $2 6 . 9 4 { \scriptstyle \pm } _ { 5 . 0 0 }$ </td><td>53.70 43.55</td><td>1</td></tr><tr><td>KIVI-K2V2*</td><td> $6 3 . 5 8 { \scriptstyle \pm _ { 0 . 6 3 } }$   $7 1 . 0 4 { \scriptstyle \pm _ { 0 . 8 3 } }$ </td><td> $3 1 . 4 5 { \scriptstyle \pm 0 . 6 2 }$   $4 4 . 1 2 \pm _ { 0 . 6 2 }$ </td><td> $5 5 . 3 0 { \scriptstyle \pm } _ { 8 . 7 2 }$   $5 6 . 7 1 { \scriptstyle \pm _ { 4 . 8 8 } }$ </td><td> $2 3 . 8 8 { \scriptstyle \pm } _ { 8 . 5 7 }$ </td><td>48.89</td><td>-10.15</td></tr><tr><td>Kitty</td><td> $7 5 . 9 9 \substack { \pm _ { 0 . 9 6 } }$ </td><td> $4 5 . 9 7 { \scriptstyle \pm 1 . 5 7 }$ </td><td> $6 0 . 0 0 { \scriptstyle \pm } 5 . 8 5$ </td><td> $2 3 . 6 7 { \scriptstyle \pm _ { 3 . 8 8 } }$ </td><td></td><td>-4.81</td></tr><tr><td> Kitty-Pro</td><td> $7 5 . 5 1 { \pm } _ { 1 . 0 6 }$ </td><td> $4 7 . 3 7 { \pm } _ { 0 . 9 0 }$ </td><td> $6 1 . 6 5 { \scriptstyle \pm 5 . 4 3 }$ </td><td> $2 5 . 4 1 \pm _ { 3 . 4 7 }$   $2 5 . 8 2 { \scriptstyle \pm _ { 3 . 7 8 } }$ </td><td>51.84 52.59</td><td>-1.86 -1.11</td></tr><tr><td rowspan="5">LLaMA3.3-70B-Instruct</td><td>K16V16</td><td> $\mathbf { 9 4 . 9 2 } \mathrm { \pm _ { 0 . 3 0 } }$ </td><td> $7 1 . 5 8 \pm _ { 1 . 1 2 }$ </td><td> $\mathbf { 8 3 . 1 3 } \pm _ { 2 . 0 3 }$ </td><td></td><td>73.89</td><td></td></tr><tr><td>KIVI-K2V2</td><td> $9 3 . 9 1 { \scriptstyle \pm _ { 0 . 5 6 } }$ </td><td> $6 6 . 0 5 { \scriptstyle \pm 0 . 7 6 }$ </td><td> $7 9 . 0 7 { \scriptstyle \pm 2 . 2 4 }$ </td><td> ${ \bf 4 5 . 9 2 } { \scriptstyle \pm _ { 2 . 5 5 } }$   $4 5 . 0 7 { \scriptstyle \pm 5 . 4 4 }$ </td><td>71.03</td><td>1 -2.86</td></tr><tr><td> ${ \mathrm { K I V I  – K } } 2 { \mathrm { V } } 2 ^ { * }$ </td><td> $9 4 . 7 7 { \scriptstyle \pm _ { 0 . 3 0 } }$ </td><td> $6 9 . 6 4 \pm _ { 0 . 8 1 }$ </td><td> $8 2 . 7 2 { \scriptstyle \pm } _ { 2 . 8 5 }$ </td><td> $4 7 . 1 1 \pm _ { 2 . 3 8 }$ </td><td>73.56</td><td>-0.33</td></tr><tr><td>Kitty</td><td> $9 5 . 0 5 { \scriptstyle \pm 0 . 6 3 }$ </td><td> $7 0 . 3 5 { \scriptstyle \pm 0 . 5 9 }$ </td><td> $8 3 . 1 3 { \pm } _ { 1 . 0 2 }$ </td><td> $4 5 . 5 8 { \scriptstyle \pm _ { 3 . 2 3 } }$ </td><td>73.53</td><td>-0.36</td></tr><tr><td> Kitty-Pro</td><td> $9 5 . 0 0 { \scriptstyle \pm 0 . 2 3 }$ </td><td> $7 0 . 7 7 { \scriptstyle \pm 0 . 5 9 }$ </td><td> $8 2 . 7 2 { \scriptstyle \pm _ { 0 . 8 1 } }$ </td><td> $4 6 . 9 4 { \scriptstyle \pm } _ { 3 . 0 6 }$ </td><td>73.86</td><td>-0.03</td></tr></table>
...
<table><tr><td>Model /Method</td><td>AIME24</td><td>AIME25</td><td> $\mathbf { A v } \mathbf { g } .$ </td></tr><tr><td>KV16 Dw-uaeg Kitty</td><td> $\mathbf { 7 1 . 6 7 { \scriptstyle \pm 1 5 . 0 0 } }$  KIVI-KV2  $5 7 . 0 0 { \scriptstyle \pm _ { 7 . 0 0 } }$  KIVI-KV2*  $6 7 . 6 7 { \scriptstyle \pm 9 . 0 0 }$   $7 0 . 6 7 { \scriptstyle \pm 7 . 3 3 }$ </td><td> ${ \bf 6 6 . 0 0 } { \bf \sigma } \mathrm { \pm } { \bf { 7 . 3 3 } }$   $5 2 . 3 3 { \scriptstyle \pm _ { 9 . 0 0 } }$   $5 7 . 6 7 { \scriptstyle \pm 9 . 0 0 }$   $5 9 . 6 7 { \scriptstyle \pm 1 0 . 3 3 }$ </td><td>68.84 54.67 62.67 65.17 75.00</td></tr><tr><td>DD-m:4348</td><td>KV16 KIVI-KV2 KIVI-KV2* Kitty</td><td> $\mathbf { 8 0 . 6 7 \pm _ { 7 . 3 3 } }$   $6 9 . 0 0 { \scriptstyle \pm _ { 9 . 0 0 } }$   $7 4 . 6 7 { \scriptstyle \pm 8 . 0 0 }$   $7 5 . 6 7 { \scriptstyle \pm _ { 4 . 3 3 } }$ </td><td> ${ \bf 6 9 . 3 3 } \pm _ { 7 . 3 3 }$   $5 5 . 3 3 { \scriptstyle \pm } _ { 8 . 6 7 }$  62.17  $6 1 . 3 3 { \scriptstyle \pm } _ { 8 . 6 7 }$  68.00  $6 7 . 3 3 \pm _ { 9 . 3 3 }$  71.50</td></tr><tr><td>DM333335</td><td>KV16 KIVI-KV2  ${ \mathrm { K I V I - K V } } 2 ^ { * }$  Kitty</td><td> $\mathbf { 8 1 . 6 7 \pm _ { 5 . 0 0 } }$   $7 3 . 0 0 { \scriptstyle \pm } _ { 9 . 6 7 }$   $7 9 . 0 0 { \scriptstyle \pm _ { 9 . 0 0 } }$   $7 9 . 6 7 { \scriptstyle \pm 9 . 6 7 }$ </td><td> $7 2 . 5 9 { \scriptstyle \pm 7 . 4 1 }$  77.13  $5 7 . 4 1 { \scriptstyle \pm _ { 9 . 2 6 } }$  65.21  $5 9 . 0 5 { \scriptstyle \pm 1 2 . 3 8 }$  69.03  $6 9 . 2 6 { \scriptstyle \pm _ { 9 . 2 6 } }$  74.47</td></tr></table>
...
As shown in Figure 5, with the same memory budget, Kitty-Pro enables 8× batch sizes and achieves $2 . 1 \times  4 . 1 \times$ higher inference throughput compared to the FP16 baseline.
