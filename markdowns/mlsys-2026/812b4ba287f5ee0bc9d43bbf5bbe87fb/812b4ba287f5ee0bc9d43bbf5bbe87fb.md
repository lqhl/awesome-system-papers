...
<table><tr><td>Key Name</td><td>Engine</td><td>Protected Communication</td><td>Number</td></tr><tr><td>{gsp_cpu,cpu-gsp}-locked_rpc</td><td rowspan="3">GSP</td><td>RPCs between CPU and GSP</td><td>2x1</td></tr><tr><td>{gsp-cpu,cpu-gsp}_dma</td><td>Memory transfers between CPU and GSP Replayable faults sent from GSP to CPU</td><td>2x1</td></tr><tr><td>gsp-cpu_replayable_fault</td><td></td><td>1</td></tr><tr><td>gsp-cpu_non_replayable_fault cpu_sec2-{data,hmac}-{user,kernel}</td><td rowspan="2">SEC2</td><td>Non-replayable faults sent from GSP to CPU Channels between CPU and SEC2</td><td>1 2x2</td></tr><tr><td>cpu_sec2_{data,hmac}_scrubber</td><td>Scrubber channels between CPU and SEC2</td><td>2x1</td></tr><tr><td>lce{x}-{h2d,d2h}-{user,kernel}</td><td>CE</td><td>Channels between CPU and CE</td><td>8x2x2</td></tr></table>
...
<table><tr><td rowspan=1 colspan=1>Data Paths</td><td rowspan=1 colspan=1>Engines</td><td rowspan=1 colspan=1>C  T</td><td rowspan=1 colspan=1>Security Findings</td></tr><tr><td rowspan=1 colspan=1>CPU-GSP RPC</td><td rowspan=1 colspan=1>GSP</td><td rowspan=1 colspan=1>·  0</td><td rowspan=1 colspan=1>Leakage and possible manipulations of RMAPI RPC invocations</td></tr><tr><td rowspan=1 colspan=1>CPU-GSP Memory Transfers</td><td rowspan=1 colspan=1>GSP</td><td rowspan=1 colspan=1>0  0</td><td rowspan=1 colspan=1>Timing channels for leaking memory transfer sizes</td></tr><tr><td rowspan=1 colspan=1>GPU Memory Faults</td><td rowspan=1 colspan=1>GSP</td><td rowspan=1 colspan=1>0  0</td><td rowspan=1 colspan=1>Leakage of PUT pointer of shadow buffers</td></tr><tr><td rowspan=1 colspan=1>UVM</td><td rowspan=1 colspan=1>SEC2, CE</td><td rowspan=1 colspan=1>：  0</td><td rowspan=1 colspan=1>Unprotected GPF IFO, GPPUT, and semaphores in SEC2 Channel</td></tr><tr><td rowspan=1 colspan=1>Memory Scrubbing</td><td rowspan=1 colspan=1>SEC2</td><td rowspan=1 colspan=1>·  0</td><td rowspan=1 colspan=1>Unprotected semaphores in SEC2 Channel</td></tr><tr><td rowspan=1 colspan=1>CUDA</td><td rowspan=1 colspan=1>SEC2, CE</td><td rowspan=1 colspan=1>？  ？</td><td rowspan=1 colspan=1>Closed-source CUDA runtime and user-mode driver</td></tr></table>
