...
> 本 topic 收录开创性/里程碑工作——那些被后续所有论文奉为共同祖先、无法被时间淘汰的基石论文。当前两篇恰好站在 **2017 → 2026 的两端**:[[Transformer]] 奠定整个 LLM 时代的架构根基,[[DeepSeek-V4-arXiv26|DeepSeek-V4]] 代表 9 年后开源 frontier model 的综合 state-of-the-art(1M context、1.6T MoE、Muon 训练、FP4 QAT、on-policy distillation),两者形成一条清晰的 "从 seed idea 到巨型系统" 传承线。
