...
在生成或改写实体/概念页的正文、表格或摘要前，必须完整阅读并执行 [中文写作与术语解释契约](../_shared/chinese-writing.md)。

同时执行契约中的“去除模板化和 AI 味”自审，删除空泛归因和套话，让判断落到具体机制、证据或边界。H1 可保留规范英文专名，但页首定义必须让非本领域读者理解它是什么。
